...
if "`variable'"=="pres_no" 					local label "Share of students attending face-to-face classes"
if "`variable'"=="vir_no" 				    local label "Share of students attending virtual classes"
if "`variable'"=="asi_no" 				    local label "Share of students not attending classes"
if "`variable'"=="hib_no" 				    local label "Share of students attending virtual or face to face classes"
...
if "`variable'"=="inac0_ocu1"				local label "Inactive to employed"
if "`variable'"=="desoc0_ocu1"				local label "Unemployed to employed"
if "`variable'"=="act0_formal1"				local label "Active to formal"
if "`variable'"=="act0_informal1"			local label "Active to informal"
if "`variable'"=="act0_desocupado1"			local label "Active to unemployed"
if "`variable'"=="act0_inac1"				local label "Active to inactive"
if "`variable'"=="inac0_ac1"				local label "Inactive to active"
if "`variable'"=="inac0_formal1"			local label "Inactive to formal"
if "`variable'"=="inac0_informal1"			local label "Inactive to informal" 
if "`variable'"=="inac0_unemp1"				local label "Inactive to unemployed"
if "`variable'"=="aumento_dom"				local label "Increase household tasks"
if "`variable'"=="aumento_childcare"		local label "Increase childcare"
if "`variable'"=="aumento_acomp"			local label "Increase acomp"
...
if "`variable'"=="pres_no" 					local module "Education"
if "`variable'"=="vir_no" 				    local module "Education"
if "`variable'"=="asi_no" 				    local module "Education"
if "`variable'"=="hib_no" 				    local module "Education"
...
if "`variable'"=="virtual1" 				local module "Education"
if "`variable'"=="hibrido1" 				local module "Education"
...
if "`variable'"=="aumento_dom"				local module "Gender"
if "`variable'"=="aumento_childcare"		local module "Gender"
if "`variable'"=="aumento_acomp"			local module "Gender"
...
if "`variable'"=="inac0_ocu1"				local module "Labor"
if "`variable'"=="desoc0_ocu1"				local module "Labor"
if "`variable'"=="act0_formal1"				local module "Labor"
if "`variable'"=="act0_informal1"			local module "Labor"
if "`variable'"=="act0_desocupado1"			local module "Labor"
if "`variable'"=="act0_inac1"				local module "Labor"
if "`variable'"=="inac0_ac1"				local module "Labor"
if "`variable'"=="inac0_formal1"			local module "Labor"
if "`variable'"=="inac0_informal1"			local module "Labor"
if "`variable'"=="inac0_unemp1"				local module "Labor"
