...
if "`variable'"=="workhome"					local label "Proportion of hours of remote work"
...
if "`variable'"=="hea3"						local label "Vaccination status"
...
if "`variable'"=="hea3"						local module "Health"
